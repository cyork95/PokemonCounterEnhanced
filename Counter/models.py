...
class Counter(models.Model):
    HUNTING_METHOD_CHOICES = (
        ('Random Encounters', 'Random Encounters'),
        ('Soft Resetting', 'Soft Resetting'),
        ('Masuda Method', 'Masuda Method'),
        ('Pokéradar', 'Pokéradar'),
        ('Chain Fishing', 'Chain Fishing'),
        ('Hidden Pokemon', 'Hidden Pokemon'),
        ('Friend Safari', 'Friend Safari'),
        ('Horde Hunting', 'Horde Hunting'),
        ('Dexnav', 'Dexnav'),
        ('S.O.S. Battles', 'S.O.S. Battles'),
        ('Wormhole', 'Wormhole'),
        ('Dynamax', 'Dynamax'),
    )
    POKEMON_GAME_CHOICES = (
        ('Gold', 'Pokemon Gold'),
        ...
        ('Lets Go Pikachu!', 'Pokemon Lets Go Pikachu!'),
    ...
    count = models.DecimalField(max_digits=10000, decimal_places=0, null=True)
    chance = models.DecimalField(max_digits=10000, decimal_places=0, null=True)
    ...
    def get_detail_url(self):
        return reverse("counter_detail", kwargs={"id": self.id})

    def get_counter_url(self):
        return reverse("counter", kwargs={"id": self.id})
